...
from strands_tweets.msg import SendTweetAction
import cv2
...
class TweetPictureState(EventState):
    ...
    def __init__(self):
        ...
        super(ApproachPersonActionState, self).__init__(outcomes = ['picture_tweeted', 'tweeting_failed','command_error'], input_keys = ['picture_path', 'tweet_text'])
    ...
    def on_enter(self, userdata):
        ...
        # Create the goal.
        tweet = SendTweetAction() 
        tweet.text = userdata.tweet_text
        tweet.with_foto = True
