...
class PickJokeState(EventState):
	...
	def __init__(self, joke_selection):
		...
		self._jokes = [	'Boy is your name home work because I am not doing you and I should be',
			...
			'Your mama is so stupid, she put two quarters in her ears and thought she was listening to 50 Cent. ', 'I am sorry, I do not think we have met. I would not forget a pretty face like that.','Life without you would be like a broken pencil. Pointless.','Can I borrow a kiss? I promise I will give it back.',
...
'Your mama is so stupid, when your dad said it was chilly outside, she ran outside with a spoon',
